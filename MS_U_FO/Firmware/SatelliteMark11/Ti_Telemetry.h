...
/*
  Telemtry format:
  0. Time       =>  [ Time ]              (Seconds)     <unsigned int>    {XXXXX}   = [ 5 Bytes ]
...
class Ti_Telemetry {
 public:
  ...
  unsigned int Time = 0, Light_intensity_1 = 0, Light_intensity_2 = 0, UV_index = 0, Radiation = 0, CO_concentration = 0, CO2_concentration = 0, O3_concentration = 0;
